...
const SimpleRepositoryAnalytics = ({ repositories, user }) => {
    ...
    const BarChart = ({ data, maxValue, className = "" }) => (
        <div className={`space-y-2 ${className}`}>
            {data.map((item, index) => (
                <div key={index} className="flex items-center space-x-3">
                    <div className="w-16 text-sm text-gray-600 dark:text-gray-300 truncate">
                        {item.label}
                    </div>
                ...
                {expandedSection === "languages" && (
                    <div className="px-6 pb-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {/* Donut Chart */}
                            <DonutChart
                                data={languageData.slice(0, 6).map((lang) => ({
                                    label: lang.language,
                                    value: lang.count,
                                }))}
                            />
                            ...
                            <div className="space-y-3">
                                ...
                                {languageData.slice(0, 8).map((lang, index) => (
                                    <div
                                        key={lang.language}
                ...
                {expandedSection === "timeline" && (
                    <div className="px-6 pb-6">
                        <BarChart
                            ...
                            maxValue={Math.max(
                                ...yearlyData.map((item) => item.repositories)
                            )}
                            className="max-h-80"
                        />
                    </div>
...
export default SimpleRepositoryAnalytics;
